...
export default function CreateBlogPage() {
  ...
  useEffect(() => {
    ...
    const draftKey = `blog_draft_${currentUserId}`
  ...
  }, [title, content, tags, coverImage, currentUserId, isAuthenticated])
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // 清除草稿
        localStorage.removeItem(`blog_draft_${currentUserId}`)
        alert('草稿已保存')
        router.push('/')
      } else {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-retro-purple/50 rounded-xl p-8 max-w-md text-center shadow-2xl">
          ...
          <p className="text-gray-300 mb-6 font-pixel">请先登录后再创作博客</p>
          <button
            onClick={() => router.push('/')}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-white font-retro">创作博客</h1>
                  {lastSaved && (
