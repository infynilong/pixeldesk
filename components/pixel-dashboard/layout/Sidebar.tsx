...
const menuItems: MenuItem[] = [
  {
    title: '概览',
    icon: '📊',
    href: '/pixel-dashboard',
  },
  {
    title: '玩家管理',
    icon: '👥',
    href: '/pixel-dashboard/players',
  },
  {
    title: '用户管理',
    icon: '👤',
    href: '/pixel-dashboard/users',
  },
  {
    title: '内容管理',
    icon: '📝',
    href: '/pixel-dashboard/posts',
  },
  {
    title: '角色形象',
    icon: '🎭',
    href: '/pixel-dashboard/characters',
  },
  {
    title: '工位管理',
    icon: '💼',
    href: '/pixel-dashboard/workstations',
  },
  {
    title: '系统设置',
    icon: '⚙️',
    ...
    subItems: [
      {
        title: '品牌配置',
        icon: '🎨',
        href: '/pixel-dashboard/settings/brand',
      },
      {
        title: '关于页面',
        icon: 'ℹ️',
...
export function Sidebar() {
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(['/pixel-dashboard/settings'])
  ...
  const handleLogout = async () => {
    ...
    try {
      await fetch('/api/pixel-dashboard/auth/logout', { method: 'POST' })
      router.push('/pixel-dashboard/login')
    } catch (error) {
